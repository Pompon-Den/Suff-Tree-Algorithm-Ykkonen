...
---------------------------
### Основная идея алгоритма заключается в нескольких модификациях <p id = "M"></p>
...
### Как же предобработать текст? <p id = "K"></p>
...
Можно заметить, что положения суффиксов бывают неявными, чтобы это исправить построим дерево для
 конкатенации исходной строки и терминального символа **$$S +"TERMINATION__SYMBOL"$$**.
...
### Как создавать суффиксные ссылки? <p id = "SuffLink"></p>
